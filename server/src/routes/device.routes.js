...
kioskRoutes.get('/active-media', kioskMediaController.getActiveMedia);
kioskRoutes.get('/stream-youtube', kioskMediaController.streamYoutube);
...
kioskRoutes.post('/verify-user', protectDevice, deviceController.verifyKioskUser);
